                            ...
                            <div class="col-md-6">
                                <table>
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>Distro Three Color</td>
                                    </tr>
                                    <tr>
                                        <td>Alamat</td>
                                        <td>:</td>
                                        <td>Jl. Kebon pedes No.02, Kota Bogor. Provinsi Jawa Barat</td>
                                    </tr>
                                    <tr>
                                        <td>No Handphone</td>
                                        <td>:</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('invoice.delete_product', ['id' => $detail->id]) }}" method="post">
                                                    ...
                                                    <button class="btn btn-danger btn-sm">Hapus</button><i class="fa fa-smile-o fa-fw"></i> hapus</a></li>
                                                </form>
                                            </td>
                                        </tr>
                                        @endforeach
